    ...
    333: function(t, e, n) {
        ...
        var i = function() {
            ...
            return t.prototype.loadAll = function() {
                ...
                this._http.post(this._baseUrl, n, this._postOptions).map(this.extractData).subscribe(function(t) {
                    e._dataStore.objects.push(t), e._dataObserver.next(e._dataStore.objects);
                }, this.handleError);
            }, t.prototype.update = function(t) {
                var e = this, n = JSON.stringify(t);
                this._http.put("" + this._baseUrl + t.id + "/", n, this._postOptions).map(this.extractData).subscribe(function(t) {
